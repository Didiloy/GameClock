          ...
          >
            ...
            >
              <template #body="slotProps">
                <div class="sh-name">
                  <span>
                    {{ slotProps.data.gameName.length > 20 && !slotProps.data.gameName.includes(" ")
            ...
            >
              <template #body="slotProps">
                <div>
                  <Button icon="pi pi-trash" severity="danger" @click="store_waiting_list.deleteSession(slotProps.data)"/>
                </div>
              </template>
            </Column>
          </DataTable>
